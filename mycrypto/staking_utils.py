...
def get_syrup_pool_contract(contract_address):
    return get_web3_client().eth.contract(address=Web3.toChecksumAddress(contract_address), abi=SYRUP_POOL_ABI)
